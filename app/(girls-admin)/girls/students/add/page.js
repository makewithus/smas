...
import { ArrowLeft, Save, Loader2, User, Phone, Home, CreditCard, Calendar, Upload } from "lucide-react";
import { db } from "@/src/lib/firebase";
import { collection, addDoc, serverTimestamp } from "firebase/firestore";
import { toast } from "sonner";
import PageHeader from "@/src/components/shared/PageHeader";
import { CLASS_OPTIONS, FEE_TYPES, PAYMENT_STATUS, ROOMS } from "@/src/lib/constants";
import { generateRollNumber } from "@/src/lib/utils";

export default function AddGirlStudentPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const rollNumber = generateRollNumber("G");
      await addDoc(collection(db, "girls_students"), {
        ...formData,
        rollNumber,
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Add a new girl student to the hostel"
        actions={
          <Link
            href="/girls/students"
